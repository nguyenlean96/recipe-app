...
public class CookbookController {
    // to control user recipe table rows where IsSaved is 1 ----- if a user saves a recipe, it will be added to the user recipe table and IsSaved will be set to 1
    ...
    public ModelAndView list(HttpServletRequest req) {
        ...
        List<Recipe> cookbook_recipes = (List<Recipe>) new ArrayList<Recipe>(curr.getCookbook_recipes());
